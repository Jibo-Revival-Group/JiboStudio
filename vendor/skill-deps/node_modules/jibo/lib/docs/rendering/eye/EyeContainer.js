 ...
 * @param {Boolean} [cache=true] `true` to cache eye and background textures.
 */

    /**
     * The cache where to load eye assets.
     * @name jibo.face.EyeContainer.CACHE_ID
     * @type {String}
     * @private
     */
     ...
     * @name jibo.face#animation
     * @type {jibo.rendering.animation.KeysAnimation}
     */
     ...
     * @param {Object} [meta] Optional object for timeline timestaps.
     */
    ...
    /**
     * Resets the layers.
     * @name jibo.face.EyeContainer#reset
     * @type {boolean}
     */
