# jibo-emotion-system
[![Build Status](http://jenkins.jibo.com/buildStatus/icon?job=jibo-emotion-system)](http://jenkins.jibo.com/job/jibo-emotion-system/)
...
###Testing
To run tests, `npm run test:debug`
