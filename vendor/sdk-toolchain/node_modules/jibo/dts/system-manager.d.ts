...
export default class SystemManager extends EventEmitter {
    ...
    wipe(callback:ErrCallback): void;
    backup(callback:ErrCallback): void;
    restore(callback:ErrCallback): void;
    poweroff(callback:ErrCallback): void;
    reboot(callback:ErrCallback): void;
    forceLogs(callback:ErrCallback): void;
}