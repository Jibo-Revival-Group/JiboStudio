...
/**
 * @prop {jibo.action} action The jibo action system for goal/abction abstraction.
 * @prop {jibo.animate} animate Jibo's animation and IK systems.
 * @prop {jibo.animdb} animdb The Jibo Animation Database.
 * @prop {jibo.attention} attention Attention manager.
 * @prop {jibo.bt} bt SDK behaviors and decorators.
 * @prop {jibo.emotion} emotion The jibo emotion system for managing and reacting to internal emotional state.
 * @prop {jibo.face} face API to jibo's face.
 * @prop {jibo.flow} flow API for the Jibo Flow Editor.
 * @prop {jibo.gl} gl Global Listen (gate to Audio Speech Recognition).
 ...
 * @prop {jibo.nlu} nlu Natural Language Understanding (cloud recognition).
 * @prop {jibo.rendering} rendering APIs for the GUI system.
 ...
 * @prop {jibo.visualize} visualize Graphic display/visualization APIs.
 * @module jibo
 ...
 */
    ...
    /**
     * `true` if Jibo has finished being initialized.
     * @name module:jibo.Runtime#context
     * @type {Object}
     * @readOnly
     */
