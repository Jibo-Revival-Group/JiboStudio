     ...
     * @name jibo.face.Component#parentGroup
     * @type {jibo.face.ComponentGroup}
     */

    /**
     * Reference to the top most parent group of this Component, which is a View.
     * @name jibo.face.Component#_parentView
     * @type {jibo.face.View}
     * @private
     */
     ...
     * @name jibo.face.Component#_touchInteractivity
     * @type {jibo.face.TouchInteractive}
     * @private
     */

    /**
     * Holds Subcomponents.
     * @name jibo.face.Component#_subcomponents
     * @type {{jibo.face.Subcomponent}}
     * @private
     */

    /**
     * Flag determining whether to respond to input.
     * @name jibo.face.Component#inputLocked
     * @type {Boolean}
     */

    /**
     * Turn interactivity on and off.
     * @method jibo.face.Component#lockInput
     ...
     * @name jibo.face.Component#parentView
     * @type {jibo.face.View}
     * @readOnly
     */
    ...
    /**
     * Add a Subcomponent.
     * @method jibo.face.Component#addSubcomponent
     * @param {jibo.face.Subcomponent} subcomponent - Subcomponent to add.
     * @returns {jibo.face.Subcomponent} Subcomponent added.
     */

    /**
     * Retrieve a Subcomponent.
     * @method jibo.face.Component#getSubcomponent
     * @param {string} type - Type of SubComponent, can access type statically from class like Subcomponent.TYPE.
     * @returns {jibo.face.Subcomponent} Subcomponent matching given type, otherwise null.
     */

    /**
     * Register with the parent group to enter the update loop.
     * If `true` registers for update, if `false` unregisters for update.
     * @method jibo.face.Component#registerUpdate
     * @param {Boolean} bool Flag to register or unregister with update.
     */

    /**
     * Cleanup method to assist with garbage collection.
     * @method jibo.face.Component#destroy
     */
     ...
     *
     * ATTENTION : This should not be called directly, the parent View {@link jibo.face.View}
     * will call this, which will recurse through Component tree.
     * @method jibo.face.Component#ready
     */

    /**
     * Manually add an asset descriptor via parameters,
     * refer to {@link jibo.loader} for documentation.
     * @method jibo.face.Component#addAssetDescriptor
     ...
     * @param {String} [cache] - Cache asset is associated with. Will use the loader's currently default cache unless otherwise specified.
     * @returns {Object}
     */

    /**
     * Manually add an asset descriptor object,
     * refer to {@link jibo.loader} for documentation on format.
     * @method jibo.face.Component#addAssetDescriptorObject
     * @param {jibo.face.ViewManager~AssetDescriptor} assetDescriptor See {@link jibo.loader} for asset format.
     * @returns {Object}
     */
     ...
     * @name jibo.face.Component#hasTouchInteractive
     * @type {Boolean}
     * @readOnly
     */
     ...
     * @name jibo.face.Component#isTouchInteractive
     * @type {Boolean}
     * @readOnly
     */

    /**
     * Add a {@link jibo.face.ActionData} and associate it with given gesture.
     ...
     * @method jibo.face.Component#addAction
     * @param {jibo.face.ActionData | string} action - The action to be triggered on click,
     ...
     * @param {string} [gesture = 'tap'] - Type of gesture the actions ae associated with.
     * @returns {jibo.face.ActionData} The ActionData added.
     */

    /**
     * Clear all actions associated with given gesture type.
     * @method jibo.face.Component#clearActions
     * @param {string} [gesture = 'tap'] - Type of gesture the actions ae associated with.
     */

    /**
     * Remove all actions of given type associated with given gesture.
     * @method jibo.face.Component#removeActionsByType
     * @param {string} [gesture = 'tap'] - Type of gesture the actions are associated with.
     */
     ...
     * @method jibo.face.Component#triggerActions
     * @param {string} [gesture = 'tap'] - Type of gesture the actions ae associated with.
     */

    /**
     * Get actions associated with given gesture type.
     * @method jibo.face.Component#getActions
     * @param {string} [gesture = 'tap'] - Type of gesture the actions ae associated with.
     * @return {jibo.face.ActionData[]} Array of actions.
     */

    /**
     * Returns `true` if there are actions associated with given gesture type.
     * @method jibo.face.Component#hasActions
     * @param {string} [gesture = 'tap'] - gesture actions related to.
