...
When you need to change API of some service:
 1) edit `apis/**.normal.json` file
 2) run `npm install`  

It will regenerate `**.min.json` file and `.js` client in `/clients` directory.
So, you get client with updated API.
