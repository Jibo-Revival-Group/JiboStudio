...
declare class Settings extends Service {
  ...
  /**
   *  Returns all Hub skill settings with values. 
   */
  ...
  /**
   *  Returns data for skill settings provided in a request. 
   */
  ...
  /**
   *  Update skill settings with values. 
   */
  ...
  /**
   *  Removes specified skill settings. At the moment available only for the Lasso service 
   */
  deleteSettings(params: Settings.Types.DeleteSettingsRequest, callback?: (err: AWSError, data: Settings.Types.DeleteSettingsResponse) => void): Request<Settings.Types.DeleteSettingsResponse, AWSError>;
  /**
   *  Removes specified skill settings. At the moment available only for the Lasso service 
   */
  deleteSettings(callback?: (err: AWSError, data: Settings.Types.DeleteSettingsResponse) => void): Request<Settings.Types.DeleteSettingsResponse, AWSError>;
}
declare namespace Settings {
  ...
  export interface SkillSettings {
    ...
    errors?: GetRequestErrors;
  }
  export type GetRequestErrors = {[key: string]: RequestError};
  export interface RequestError {
    message: undefined;
  }
  export type SkillSettingData = {[key: string]: SettingValue};
  export type SkillIds = undefined[];
  ...
  export type SkillView = {[key: string]: any};
